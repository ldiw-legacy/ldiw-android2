...
public abstract class BasicMapFragment extends SupportMapFragment implements BasicInterface{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		manager = new AsyncTaskController(BasicMapFragment.this);
		mConnectionController = ConnectionController.getInstance(mContext);
		mLocationController = LocationController.getInstance(BasicMapFragment.this);
