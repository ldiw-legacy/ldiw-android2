...
public abstract class BasicFragment extends Fragment implements BasicInterface{
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		manager = new AsyncTaskController(BasicFragment.this);
		mConnectionController = ConnectionController.getInstance(mContext);
		mLocationController = LocationController.getInstance(BasicFragment.this);
